...
//#line 280 "/opt/ros/install_isolated/lib/python2.7/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(MLSConfig::AbstractParamDescriptionConstPtr(new MLSConfig::ParamDescription<int>("spatial_locator", "int", 0, "Set the spatial locator", "{'enum_description': 'Set the spatial locator', 'enum': [{'srcline': 9, 'description': 'ANN', 'srcfile': '/opt/ros/src/perception_pcl/pcl_ros/cfg/MLS.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'ANN'}, {'srcline': 9, 'description': 'FLANN', 'srcfile': '/opt/ros/src/perception_pcl/pcl_ros/cfg/MLS.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'FLANN'}, {'srcline': 9, 'description': 'Dense/organized data locator', 'srcfile': '/opt/ros/src/perception_pcl/pcl_ros/cfg/MLS.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'organized'}]}", &MLSConfig::spatial_locator)));
//#line 280 "/opt/ros/install_isolated/lib/python2.7/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/opt/ros/src/perception_pcl/pcl_ros/cfg/MLS.cfg"
      const int MLS_ANN = 0;
//#line 9 "/opt/ros/src/perception_pcl/pcl_ros/cfg/MLS.cfg"
