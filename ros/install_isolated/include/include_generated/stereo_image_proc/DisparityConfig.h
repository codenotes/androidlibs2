...
//#line 280 "/opt/ros/install_isolated/lib/python2.7/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(DisparityConfig::AbstractParamDescriptionConstPtr(new DisparityConfig::ParamDescription<int>("stereo_algorithm", "int", 0, "sterel algorithm", "{'enum_description': 'stereo algorithm', 'enum': [{'srcline': 11, 'description': 'Block Matching', 'srcfile': '/opt/ros/src/image_pipeline/stereo_image_proc/cfg/Disparity.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'StereoBM'}, {'srcline': 12, 'description': 'SemiGlobal Block Matching', 'srcfile': '/opt/ros/src/image_pipeline/stereo_image_proc/cfg/Disparity.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'StereoSGBM'}]}", &DisparityConfig::stereo_algorithm)));
//#line 280 "/opt/ros/install_isolated/lib/python2.7/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 11 "/opt/ros/src/image_pipeline/stereo_image_proc/cfg/Disparity.cfg"
      const int Disparity_StereoBM = 0;
//#line 12 "/opt/ros/src/image_pipeline/stereo_image_proc/cfg/Disparity.cfg"
