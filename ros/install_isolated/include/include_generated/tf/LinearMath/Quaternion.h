...
public:
  ...
  Quaternion(const tfScalar& yaw, const tfScalar& pitch, const tfScalar& roll)// __attribute__((deprecated)) //GREG1
	{ 
   ...
   * @param pitch Angle around Y
   * @param roll Angle around X */
  void setEulerZYX(const tfScalar& yaw, const tfScalar& pitch, const tfScalar& roll)// __attribute__((deprecated)) //GREG1
	{
          setRPY(roll, pitch, yaw);
	}
