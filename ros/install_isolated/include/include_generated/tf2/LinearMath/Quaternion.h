...
public:
  ...
  Quaternion(const tf2Scalar& yaw, const tf2Scalar& pitch, const tf2Scalar& roll) //__attribute__((deprecated)) //GREG1
	{ 
   ...
   * @param pitch Angle around Y
   * @param roll Angle around X */
  void setEulerZYX(const tf2Scalar& yaw, const tf2Scalar& pitch, const tf2Scalar& roll) //__attribute__((deprecated)) //greg1
	{
          setRPY(roll, pitch, yaw);
	}
