...
#include <triangulator/beaconBest.h>
...
struct beaconCommand_
{
  ...
  _stringArgs_type stringArgs;
   ...
   typedef  ::triangulator::beaconSettings_<ContainerAllocator>  _bSettings_type;
  _bSettings_type bSettings;

   typedef std::vector< ::triangulator::beaconBest_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::triangulator::beaconBest_<ContainerAllocator> >::other >  _bBeaconBest_type;
  _bBeaconBest_type bBeaconBest;
...
struct MD5Sum< ::triangulator::beaconCommand_<ContainerAllocator> >
{
  ...
  {
    return "784e3e34045096c4cfbaefe49e7e2573";
  }

  static const char* value(const ::triangulator::beaconCommand_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x784e3e34045096c4ULL;
  static const uint64_t static_value2 = 0xcfbaefe49e7e2573ULL;
};
...
struct Printer< ::triangulator::beaconCommand_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::triangulator::beaconCommand_<ContainerAllocator>& v)
  {
    ...
    s << indent << "bSettings: ";
    s << std::endl;
    Printer< ::triangulator::beaconSettings_<ContainerAllocator> >::stream(s, indent + "  ", v.bSettings);
    s << indent << "bBeaconBest[]" << std::endl;
    for (size_t i = 0; i < v.bBeaconBest.size(); ++i)
    {
      s << indent << "  bBeaconBest[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::triangulator::beaconBest_<ContainerAllocator> >::stream(s, indent + "    ", v.bBeaconBest[i]);
    }
